...
class PreTrainedConfig(draccus.ChoiceRegistry, HubMixin, abc.ABC):  # type: ignore[misc,name-defined] #TODO: draccus issue
    ...
    def from_pretrained(
        ...
        **policy_kwargs: Any,
        ...
        # apply cli overrides. The base choice class needs the discriminator, while
        # a concrete subclass must see it removed from its dataclass fields.
        ...
        if cls is not PreTrainedConfig:
            with draccus.config_type("json"):
                orig_config = draccus.parse(cls, config_file, args=[])
